    ...
    def printLetters(self):
        for i in range(len(self.letterList)):
            try:
                ...
                elif self.letterList[i] == 32:
                    self.letterList[i] = ' '
                elif self.letterList[i] == 304:
                    self.letterList = self.letterList[:-1]
                    self.shift = True
                elif self.letterList[i] == 301:
                    self.letterList = self.letterList[:-1]
...
quitButton = button('Quit', 'center', 360, (0, 0, 0), (200, 200, 200), (0,0,0), 16, 'pygame.quit()', 'sys.exit()')
objects.add(quitButton)
inputBox = inputText('left', 100, 200, 'Type here...', (100,100,100), (200, 200, 200), (0, 0, 0), 16)
inputBox.displayInputText()
